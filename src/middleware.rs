    ...
    M: Middleware,
{
    ...
    pub fn new(inner: M) -> Self {
        // TODO: discuss an appropriate timeout, 4 seconds is a very random decision
        CCIPReadMiddleware::new_with_timeout(inner, Duration::from_secs(4))
    }

    pub fn new_with_timeout(inner: M, timeout: Duration) -> Self {
        Self {
            inner,
            // ens: None,
